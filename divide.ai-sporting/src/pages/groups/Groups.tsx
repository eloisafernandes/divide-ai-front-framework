...
export function Groups() {
  ...
  const handleGroupClick = (group: ISporting) => {
  ...
  return (
    <div className="flex-1 space-y-4 p-4 pt-6 lg:mx-10">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
        <h2 className="text-3xl font-bold tracking-tight">Gerenciar Eventos Esportivos</h2>
      ...
      {/* Lista de Grupos */}
      {Array.isArray(data) && data.map((groupCard: ISporting) => (
